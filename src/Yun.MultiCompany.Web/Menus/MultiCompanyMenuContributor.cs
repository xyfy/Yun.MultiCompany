...
namespace Yun.MultiCompany.Web.Menus
{
    public class MultiCompanyMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public MultiCompanyMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<MultiCompanyResource>();

            context.Menu.Items.Insert(
                0,
                new ApplicationMenuItem(
                    MultiCompanyMenus.Home,
                    l["Menu:Home"],
                    "~/",
                    icon: "fas fa-home",
                    order: 0
